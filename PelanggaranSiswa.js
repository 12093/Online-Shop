...
class PelanggaranSiswa extends Component {
        ...
        return (
            <div className="container">
                <div className="card my-2">
                    ...
                    <h4 className="text-white">Data Pelanggaran Siswa</h4>
                </div>
    ...
    <Modal id="modal_pelanggaran" bg_header="danger" text-header="white">
        <form onSubmit={this.Save}>
            ...
            <button type="button" className="btn btn-block btn-sm btn-primary my-2"
